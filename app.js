...
const translations = {
  zh: {
    ...
    heroLead:
      "Singularity Games 致力于打造创新、沉浸式的游戏体验和 AI 应用，用动态世界、智能角色与全息交互连接玩家的下一次冒险。",
    heroPrimary: "探索产品",
    heroSecondary: "了解更多",
    ...
    productsTitle: "把奇点引擎装进每一个世界",
    productsLead: "以游戏、AI 对话、智能创作与 SaaS 系统为核心，构建跨平台的互动产品矩阵。",
    tagFeatured: "重点产品",
    product1Title: "奇幻岛",
    ...
    product3Title: "荒岛大师家",
    product3Body: "在荒岛冒险游戏中收集名探险家，在神秘岛屿上求生存。",
    product4Body: "面向日本用户设计的聊天键盘与 AI 助手，让日语沟通更自然。",
    product5Body: "面向中小地产公司设计的 SaaS 管理系统，统一组织租赁、合同与客户。",
    product6Title: "毒舌坊主",
    product6Body: "20+ 角色、增强 3D、口才挑战，创造热闹又爽快的真人派对游戏。",
    product7Body: "休闲贪吃蛇成长游戏，吞噬、进化、变强并挑战最终蛇王。",
    product8Title: "更多产品",
    product8Body: "更多有趣的游戏与 AI 应用正在开发中，敬请期待。",
    learnMore: "了解更多",
    seeAll: "查看全部产品",
    advantagesKicker: "为什么选择我们",
    advantagesTitle: "沉浸式娱乐与 AI 工程的交汇点",
    adv1Title: "创新游戏体验",
    adv1Body: "专注于创造独特而有趣的游戏体验，为玩家带来前所未有的沉浸式体验。",
    adv2Title: "先进 AI 技术",
    adv2Body: "利用最先进的 AI 技术，为用户提供智能、个性化的服务和体验。",
    adv3Title: "用户至上",
    adv3Body: "始终将用户体验放在首位，不断优化产品，满足用户需求。",
